...
gene_expression_data <- FetchData(so_raw_copy, vars = c("ENSMUSG00000031311", "Type"))

# Create the violin plot
v1<- VlnPlot(so_raw_copy, features = "ENSMUSG00000031311", group.by = "Type") +
      ggtitle("Expression of ENSMUSG00000031311 Across Cell Types") +
      theme_minimal() +
...
# Create the violin plot for the selected cell types
VlnPlot(selected_cell_types, features = "ENSMUSG00000031311", group.by = "Type") +
