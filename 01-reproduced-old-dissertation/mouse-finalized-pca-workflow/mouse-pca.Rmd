...
### Only include single cells samples
```{r}
...
## Create panel plots to facilitate the comparision between the three functions
...
# Save the renvironment information
```{r}
