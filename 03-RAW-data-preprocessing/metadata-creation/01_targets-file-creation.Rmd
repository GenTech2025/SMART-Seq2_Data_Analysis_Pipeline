...
```{r}
mapping <- read.csv("/home/s2599932/MSc_DSB_Dissertation_2024/02-ranked-SEG-enrichment/GSMtoSRR/GSE71318_gsm_to_srr_mapping.csv", header = TRUE)
colnames(mapping) <- c("Sample_ID","Run_Accession")

# Merge the two data frame to get the complete data frame
GSE71318_targets <- merge(targets, mapping, by="Sample_ID", all.x = TRUE)

# Save the targets file as CSV
write.csv(GSE71318_targets, file = "./GSE71318_targets.csv",row.names = FALSE)
```
