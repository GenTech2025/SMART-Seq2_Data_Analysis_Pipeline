...
```{r}
t1 <- read.table("/scratch1/s2599932/E-MTAB-3929/counts/all_samples_featureCounts.txt",header = TRUE, row.names = 1)
```
...
```{r}
write.csv(t1, file = "/home/s2599932/study-datasets/E-MTAB-3929_self_processed/E-MTAB-3929_counts.csv", row.names = TRUE)
```
