...
### Define File Paths
```{r}
dataset_one_dir <- "/home/s2599932/mouse-dataset/E-MTAB-2600/single_es_tximport.rds" # E-MTAB-2600
dataset_two_dir <- "/home/s2599932/mouse-dataset/GSE121708/counts.txt" # GSE121708
dataset_one_annotation_dir <- "/home/s2599932/mouse-dataset/E-MTAB-2600/E-MTAB-2600.targets.txt"
dataset_two_annotation_dir <- "/home/s2599932/mouse-dataset/GSE121708/sample_metadata.txt"
```
### Load Libraries
```{r}
library(Seurat)
...
colsums <- colSums(assay(sce_two_fil, "counts")) # Needs to be calculated from the same SCE object
hist(colsums, breaks = 40)

# Verify the length of colsums matches the number of columns in the assay
length(colsums) == ncol(sce_two_fil)
```
