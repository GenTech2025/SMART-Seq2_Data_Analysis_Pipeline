...
#### Only keep the first occurence of a gene (not used)
```{r}
# Load necessary libraries
library(dplyr)
library(tibble)
...
```{r}
hist(fgsea_one$pval, breaks=50, main="Adjusted P-value distribution for one", xlab="P-value")
hist(fgsea_two$pval, breaks=50, main="Adjusted P-value distribution for two", xlab="P-value")
```
