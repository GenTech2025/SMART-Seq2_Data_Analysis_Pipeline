...
write.csv(sce_one_seg_df, file = "./original_EMTAB3929_SEG_table.csv", row.names = FALSE)
write.csv(sce_two_seg_df, file = "./original_GSE75748_SEG_table.csv", row.names = FALSE)
...
write.csv(sce_one_df_clean, file = "./unionlist_EMTAB3929_SEG_table.csv", row.names = FALSE)
write.csv(sce_two_df_clean, file = "./unionlist_GSE75748_SEG_table.csv", row.names = FALSE)
...
#### Define genes for which the heatmap comparisions are to be made
```{r}
# Define the genes
...
gene6 <- "ENSG00000204531" # POU5F1 (has got multiple enesembl IDs)
```
...
save_combined_plot(sfrp1_plot, "./Heatmaps/sfrp1_heatmap.png")
save_combined_plot(tcf7l1_plot, "./Heatmaps/tcf7l1_heatmap.png")
save_combined_plot(pou5f1_plot, "./Heatmaps/pou5f1_heatmap.png")
```
